...
# library for on-device LLM post-processing (issue #6). Always required so ASR
# polish is available in a normal Kea build.
#
...
set(KEA_LLAMA_GGML_INCLUDE_DIR "${_llama_src}/ggml/include")
set(KEA_LLAMA_LIB_DIR "${_llama_bld}/bin")
set(KEA_LLAMA_LIB "${_llama_bld}/bin/libllama.so")

message(STATUS "llama.cpp: always built from ${KEA_LLAMA_GIT_REPOSITORY}@${KEA_LLAMA_GIT_TAG}")
